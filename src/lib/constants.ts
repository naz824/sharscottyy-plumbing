...
export const TESTIMONIALS = [
  ...
  {
    name: "Flower O.",
    quote: "Carlos came by my Airbnb last minute because my toilet would not flush. He explained exactly what needed replaced, broke down the price and did not overcharge. Look no further for a reliable plumber!",
    date: "March 2023",
    platform: "Yelp",
    rating: 5,
    verified: true,
  ...
  {
    name: "Remi B.",
    quote: "He gave free consultation unlike other plumbers that wanted a consultation fee. He charged a reasonable flat rate and helped me buy the parts. Super resourceful.",
    date: "December 2020",
    platform: "Yelp",
    rating: 5,
    verified: true,
  ...
  {
    name: "Dona R.",
    quote: "SOOOO knowledgeable! He gives an estimate and I think he is fairly priced. He really cleans up EVERYTHING when the job is done. BEST plumber I have ever used.",
    date: "March 2021",
    platform: "Yelp",
    rating: 5,
    verified: true,
  ...
  {
    name: "Nadine L.",
    quote: "His price was WAY under the flat fees from other companies who never even bothered to diagnose the problem. Carlos even gave me a discount. Professional and polite.",
    date: "February 2021",
    platform: "Yelp",
    rating: 5,
    verified: true,
  ...
  {
    name: "Shannon F.",
    quote: "Kind and patient even during a stressful time. Replaced our hot water heater.",
    date: "April 2021",
    platform: "Yelp",
    rating: 5,
    verified: true,
  ...
  {
    name: "Joe G.",
    quote: "Very quick to respond and worked diligently and professionally. Removed old gas pipe buried in concrete wall.",
    date: "February 2021",
    platform: "Yelp",
    rating: 5,
    verified: true,
  ...
  {
    name: "Wyatt P.",
    quote: "Quick to respond even during a pandemic. Removed old gas line and installed new one, also updated water heater. Completed in one afternoon.",
    date: "January 2021",
    platform: "Yelp",
    rating: 5,
    verified: true,
  ...
  {
    name: "Pete P.",
    quote: "Great service and pricing. Carlos showed up right away after calling him.",
    date: "March 2021",
    platform: "Yelp",
    rating: 5,
    verified: true,
  ...
  {
    name: "Stav F.",
    quote: "Very responsive, showed up as promised. Reasonably priced.",
    date: "December 2020",
    platform: "Yelp",
    rating: 5,
    verified: true,
  ...
  {
    name: "Daniel C.",
    quote: "Very responsive and got the job done. Replaced two valves and worked around additional issues found.",
    date: "February 2021",
    platform: "Yelp",
    rating: 5,
    verified: true,
  ...
  {
    name: "Maurice W.",
    quote: "Most companies spent 10 minutes looking at my project and left. Carlos spent an hour asking what I wanted and explaining what needed to be done.",
    date: "2022",
    platform: "Google",
    rating: 5,
    verified: true,
  ...
  {
    name: "Jordi B.",
    quote: "Replaced the existing shower unit with a US brand as recommended. Superior performance.",
    date: "2023",
    platform: "Google",
    rating: 5,
    verified: true,
  ...
  {
    name: "Phoenix",
    quote: "He responded quickly, quoted me a fair price, and was very knowledgeable.",
    date: "2025",
    platform: "Google",
    rating: 5,
    verified: true,
  ...
  {
    name: "RoKa RoKa",
    quote: "Very dedicated and professional. Someone who cares about his performance and reputation.",
    date: "2022",
    platform: "Google",
    rating: 5,
    verified: true,
